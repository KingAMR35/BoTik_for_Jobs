...
В регионах — от 25 до 60 тысяч рублей.''')
        ...
        if call.data == 'button277':
            ...
            button505 = types.InlineKeyboardButton(text="Преподаватели физики", callback_data='button505')
...
''')
        ...
        if call.data == 'button506':
            ...
            button512 = types.InlineKeyboardButton(text="Преподаватели физики", callback_data='button512')
            bt21 = types.InlineKeyboardButton(text="Вернуться 🔙", callback_data="bt21")
        ...
        if call.data == 'button511':
            bot.send_message(call.message.chat.id, "Биолог -- это специалист, который изучает живые организмы, их строение, функции, эволюцию и взаимодействие с окружающей средой. Биологи проводят научные исследования на разных уровнях организации живой материи: от молекул и клеток до экосистем и биосферы в целом. ")
        if call.data == 'button512':
            bot.send_message(call.message.chat.id, "Преподаватели физики -- это педагоги, которые специализируются на преподавании физики ученикам различных уровней образования. ")
