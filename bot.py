...
Главный эколог предприятия (10+ лет) — 100–200 тысяч рублей.''')
        ...
        if call.data == 'button307':
            ...
            button404 = types.InlineKeyboardButton(text="Медицинский исследователь", callback_data='button404')
            button405 = types.InlineKeyboardButton(text="Медицинский диагност", callback_data='button405')
            bt21 = types.InlineKeyboardButton(text="Вернуться 🔙", callback_data="bt21")
...
Пермь — 50 000 рублей.''')
        if call.data == 'button404':
            bot.send_message(call.message.chat.id, "Медицинский диагност -- это ")
