...
#==========================================================================================================================================
        ...
        if call.data == 'button304':
            ...
            button346 = types.InlineKeyboardButton(text="Ознакомиться🔎", callback_data='button346')
            bt21 = types.InlineKeyboardButton(text="Вернуться 🔙", callback_data="bt21")
        ...
        if call.data == 'button338':
            ...
            bot.send_message(call.message.chat.id, "Размер заработной платы торгового представителя зависит от компании, обязанностей и опыта работы. Эксклюзивный торговый представитель в ГК «Черноголовка» — от 120 000 рублей, полный рабочий день, опыт от 1 года. орговый представитель/менеджер по продажам в ООО «Элитные Агросистемы» — от 85 000 рублей, полный рабочий день, опыт от 1 года.")
        ...
        if call.data == 'button340':
            ...
            bot.send_message(call.message.chat.id, "Примерный доход эксперта по закупкам: Новички (0–2 года опыта) — 35 000–55 000 рублей. Опытные (2–5 лет стажа) — 55 000–85 000 рублей. Профи (5+ лет опыта) — 85 000–150 000+ рублей.")
        if call.data == 'button341':
            ...
            bot.send_message(call.message.chat.id, "Заработная плата может отличаться в зависимости от города: Москва — 115 000 рублей; Санкт-Петербург — 100 000 рублей; Красноярск — 90 000 рублей; Воронеж — 80 000 рублей; Екатеринбург — 75 000 рублей.")
        if call.data == 'button342':
            ...
            bot.send_message(call.message.chat.id, "Размер заработной платы может отличаться в зависимости от города: Москва — 133 000 рублей; Рязань — 100 000 рублей; Ростов-на-Дону — 100 000 рублей")
        ...
        if call.data == 'button344':
            ...
            bot.send_message(call.message.chat.id, "Размер заработной платы может отличаться в зависимости от города: Химки — 75 000 рублей; Москва — 55 000 рублей; Санкт-Петербург — 48 000 рублей")
        ...
        if call.data == 'button305':
            ...
            button363 = types.InlineKeyboardButton(text="Ознакомиться🔎", callback_data='button363')
            bt21 = types.InlineKeyboardButton(text="Вернуться 🔙", callback_data="bt21")
        ...
        if call.data == 'button363':
            ...
            button365 = types.InlineKeyboardButton(text="Мобильный разработчик", callback_data='button365')
            button366 = types.InlineKeyboardButton(text="Системный администратор", callback_data='button366')
            button367 = types.InlineKeyboardButton(text="Администратор баз данных", callback_data='button367')
            button368 = types.InlineKeyboardButton(text="Инженер по кибербезопасности", callback_data='button368')
            button369 = types.InlineKeyboardButton(text="Инженер по DevOps", callback_data='button369')
            bt21 = types.InlineKeyboardButton(text="Вернуться 🔙", callback_data="bt21")
            keyboard.row(button364)
            keyboard.row(button365)
            keyboard.row(button366)
            keyboard.row(button367)
            keyboard.row(button368)
            keyboard.row(button369)
            keyboard.row(bt21)
            bot.send_message(call.message.chat.id, "Выберите профессию с которой вы хотите ознакомиться.", reply_markup=keyboard)
            
        if call.data == 'button364':
            bot.send_message(call.message.chat.id, "Веб-разработчик -- это специалист, который занимается созданием и поддержкой сайтов и веб-приложений. Он может работать как над внешним видом, так и над внутренней частью сайта.")
        if call.data == 'button365':
        ...
        if call.data == 'button369':
            bot.send_message(call.message.chat.id, "Инженер по DevOps -- это специалист, который объединяет процессы разработки и эксплуатации программного обеспечения. Слово DevOps расшифровывается как Development (разработка) + Operations (эксплуатация) — это подход, который объединяет создание программного обеспечения и поддержку сервисов — например, серверов, баз данных и систем, на которых работает приложение.")
                
                  
        if call.data == 'button346':
            keyboard = types.InlineKeyboardMarkup()
            button347 = types.InlineKeyboardButton(text="Менеджер по продажам", callback_data='button347')
            button348 = types.InlineKeyboardButton(text="Торговый представитель", callback_data='button348')
            button349 = types.InlineKeyboardButton(text="Менеджер по работе с клиентами", callback_data='button349')
            button350 = types.InlineKeyboardButton(text="Специалист по закупкам", callback_data='button350')
            button351 = types.InlineKeyboardButton(text="Менеджер по развитию бизнеса", callback_data='button351')
            button352 = types.InlineKeyboardButton(text="Менеджер по дистрибуции", callback_data='button352')
            button353 = types.InlineKeyboardButton(text="Специалист по маркетингу", callback_data='button353')
            button354 = types.InlineKeyboardButton(text="Менеджер по интернет-продажам", callback_data='button354')
            button355 = types.InlineKeyboardButton(text="Менеджер по корпоративным продажам", callback_data='button355')
            bt21 = types.InlineKeyboardButton(text="Вернуться 🔙", callback_data="bt21")
            keyboard.row(button347)
            keyboard.row(button348)
            keyboard.row(button349)
            keyboard.row(button350)
            keyboard.row(button351)
            keyboard.row(button352)
            keyboard.row(button353)
            keyboard.row(button354)
            keyboard.row(button355)
            keyboard.row(bt21)
            bot.send_message(call.message.chat.id, "Выберите раздел, с которым вы хотите ознакомиться.", reply_markup=keyboard)
            
        if call.data == 'button347':
            bot.send_message(call.message.chat.id, "Менеджер по продажам -- это специалист, который занимается продвижением товаров или услуг компании, взаимодействует с клиентами и обеспечивает выполнение планов продаж.")
        if call.data == 'button348':
            bot.send_message(call.message.chat.id, "Торговый представитель -- это специалист в области продаж и маркетинга, который представляет продукцию или услуги компании перед потенциальными клиентами, партнёрами или розничными точками продаж.")
        if call.data == 'button349':
            bot.send_message(call.message.chat.id, "Менеджер по работе с клиентами -- это специалист, который выступает связующим звеном между компанией и её покупателями. Его задача — создавать долгосрочные отношения, помогая бизнесу становиться успешнее.")
        if call.data == 'button350':
            bot.send_message(call.message.chat.id, "Специалист по закупкам -- это профессионал, который отвечает за то, чтобы бизнес получал всё необходимое для работы без переплат и задержек.")
        if call.data == 'button351':
            bot.send_message(call.message.chat.id, "Менеджер по развитию бизнеса -- это  специалист, который отвечает за поиск и реализацию новых возможностей для роста компании. Он анализирует рыночные тренды, разрабатывает стратегии для расширения бизнеса, ведёт переговоры с потенциальными партнёрами и помогает компании выйти на новые рынки. ")
        if call.data == 'button352':
            bot.send_message(call.message.chat.id, "Менеджер по дистрибуции -- это специалист, который отвечает за продвижение товаров от производителя к конечному потребителю. Его работа включает организацию каналов продаж, стимулирование сбыта и внедрение маркетинговых стратегий.")
        if call.data == 'button353':
            bot.send_message(call.message.chat.id, "Специалист по маркетингу -- это профессионал, который занимается исследованием рынка, анализом спроса и предложения, разработкой и реализацией маркетинговых стратегий для продвижения товаров и услуг.")
        if call.data == 'button354':
            bot.send_message(call.message.chat.id, "Менеджер по интернет-продажам -- это специалист, отвечающий за организацию и развитие продаж товаров или услуг через интернет.")
        if call.data == 'button355':
            bot.send_message(call.message.chat.id, "Менеджер по корпоративным продажам -- это специалист, который отвечает за взаимодействие с ключевыми клиентами компании (B2B-сегмент). В отличие от обычного менеджера по продажам, он работает с крупными заказчиками, заключает долгосрочные контракты и выстраивает стратегические партнёрства.")
        ...
        if call.data == 'button321':
            ...
            bot.send_message(call.message.chat.id, "Экономист-аналитик зарабатывает 100 000–120 000 рублей в месяц на руки предлагает группа компаний «Триумф» экономисту-аналитику с опытом 1–3 года.")
            bot.send_message(call.message.chat.id, "От 230 000 рублей в месяц до вычета налогов предлагает компания «Наяда» экономисту-аналитику с опытом 3–6 лет")
            bot.send_message(call.message.chat.id, "От 160 000 до 205 000 рублей в месяц предлагает компания «УК Инфраструктурные Инвестиции» ведущему экономисту-аналитику энергетического холдинга.")
        if call.data == 'button322':
            ...
            bot.send_message(call.message.chat.id, "Инвест-аналитик зарабатывает: начальный уровень: от 80 000 до 120 000 рублей в месяц (для аналитиков без опыта). Средний уровень: от 120 000 до 180 000 рублей в месяц (для опытных специалистов). В крупных городах и на известных проектах эта сумма может быть значительно выше. Эксперт: от 180 000 до 250 000 рублей в месяц (для топовых инвестиционных аналитиков, работающих на высокобюджетных проектах).")
        ...
        if call.data == 'button326':
            ...
            bot.send_message(call.message.chat.id, "Кассир — 40 000–70 000 рублей в месяц. Специалист по кредитованию — 70 000–120 000 рублей в месяц. Бизнес-аналитик — 90 000–150 000 рублей в месяц. Финансовый менеджер — 100 000–200 000 рублей в месяц. Руководитель отдела — 150 000–300 000 рублей в месяц.")
        ...
        if call.data == 'button328':
            ...
            bot.send_message(call.message.chat.id, "Начинающий консультант — 45 000–70 000 рублей; Консультант с опытом 2–3 года — 80 000–120 000 рублей; Ведущий консультант — 130 000–200 000 рублей; Персональный финансовый советник — от 250 000 рублей.")
        ...
        if call.data == 'button330':
            ...
            bot.send_message(call.message.chat.id, "Начинающие специалисты (опыт до 1–2 лет) — в среднем 70 000–100 000 рублей в месяц. Специалисты среднего звена (опыт 2–5 лет) — в среднем 120 000–200 000 рублей в месяц.Опытные аналитики (опыт более 5 лет) — от 200 000 до 350 000 рублей в месяц. Особенно высоко оплачиваются специалисты с опытом работы в международных компаниях и профессиональными сертификатами (CFA, ACCA).")
            bot.send_message(call.message.chat.id, "Руководители финансовой аналитики — от 350 000 до 700 000 рублей и выше. В крупных компаниях и инвестиционных фондах эта сумма может достигать 1 000 000–1 500 000 рублей в месяц.")
        ...
        if call.data == 'button336':
            ...
            bot.send_message(call.message.chat.id, "Новичок может получать около 35 тысяч рублей. Опытный специалист с навыками управления может зарабатывать от 60–70 тысяч рублей. Для этого нужно проработать в сфере 1–3 года. Ведущий или главный экономист может получать около 200 тысяч рублей.  Финансовый директор — от 250 тысяч рублей в месяц.")
