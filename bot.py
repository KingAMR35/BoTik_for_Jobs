...
Детский и подростковый психолог — 80 000 рублей в месяц, диапазон — 50 000–150 000 рублей.''')
        ...
        if call.data == 'button309':
            keyboard = types.InlineKeyboardMarkup()
            button414 = types.InlineKeyboardButton(text="", callback_data='button414')
            button415 = types.InlineKeyboardButton(text="", callback_data='button415')
            button416 = types.InlineKeyboardButton(text="", callback_data='button416')
            button417 = types.InlineKeyboardButton(text="", callback_data='button417')
            button418 = types.InlineKeyboardButton(text="", callback_data='button418')
            button419 = types.InlineKeyboardButton(text="", callback_data='button419')
            button420 = types.InlineKeyboardButton(text="", callback_data='button420')
            button421 = types.InlineKeyboardButton(text="", callback_data='button421')
            bt21 = types.InlineKeyboardButton(text="Вернуться 🔙", callback_data="bt21")
