...
def start_bot(message):
    bot.send_message(message.chat.id, f"Привет, {message.from_user.first_name}! Кто я такой? Я ТГ бот, созданный @KingAMR35, который помогает людям выбирать профессию и полностью рассказать о ней. Этот бот поможет найти себя в будущем!", reply_markup=start_keyboard())
...
def start_keyboard():
    ...
    button2 = types.InlineKeyboardButton(text="🔍🔥 Углублённый поиск --В разработке--", callback_data="button2")
...
def start():
    keyboard = types.InlineKeyboardMarkup()
    button1 = types.InlineKeyboardButton(text="Математические предметы", callback_data='button204')
    button2 = types.InlineKeyboardButton(text="Гуманитарные науки", callback_data='button205')
    button3 = types.InlineKeyboardButton(text="Естественно научные предметы", callback_data='button206')
...
#============================================================Медицина💉💊
            ...
            bt1 = types.InlineKeyboardButton(text="Вернуться 🔙", callback_data="bt")
